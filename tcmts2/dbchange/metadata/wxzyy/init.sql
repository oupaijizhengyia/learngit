...
UPDATE `wxzyy`.`sys_module` SET `config`='{ \"ribbon\": [{\"type\": \"dateTime\",\"label\": \"开始时间\",\"code\": \"startDate\"},{\"type\": \"dateTime\",\"label\": \"结束时间\",\"code\": \"endDate\"},{\"type\": \"dropdown\", \"label\": \"门诊/住院\",\"code\": \"belong\"},{\"type\": \"dropdown\", \"label\": \"煎药方式\",\"code\": \"boilType\"},{\"type\": \"dropdown\", \"label\": \"流程状态\",\"code\": \"shippingState\"},{\"type\": \"dropdown\", \"label\": \"打印状态\",\"code\": \"printState\"},{\"type\": \"dropdown\", \"label\": \"用法\",\"code\": \"takeType\"},{\"type\": \"dropdown\", \"label\": \"锁定状态\",\"code\": \"lockState\"},{\"label\": \"系统处方号\",\"code\": \"sysRecipeCode\"},{\"label\": \"发票号\",\"code\": \"invoiceCode\"},{\"label\": \"门诊号\",\"code\": \"outpatientNum\"},{\"label\": \"患者姓名\",\"code\": \"recipientName\"},{\"type\":\"dropdown\",\"label\": \"审方员\",\"code\": \"dispenseId\"},{\"label\": \"医生\",\"code\": \"doctorName\"},{\"label\": \"病区\",\"code\": \"inpatientArea\"},{\"label\": \"床号\",\"code\": \"bedNumber\"},{\"type\":\"dropdown\",\"label\": \"配送方式\",\"code\": \"carryId\"},{\"label\": \"物流单号\",\"code\": \"logisticsCode\"}],\"button\": [{\"label\": \"查询\",\"action\":\"search\",\"method\":\"onSearch\"},{\"label\": \"重置\",\"action\":\"reset\",\"method\":\"onReset\"},{\"label\": \"新增\",\"action\":\"addNew\",\"method\":\"onAddNew\"},{\"label\":\"门诊审方\", \"action\": \"outPatientCheck\", \"method\":\"onOutPatientCheck\"}, {\"label\":\"住院审方\", \"action\": \"hospitalCheck\", \"method\":\"onHospitalCheck\"}, {\"label\": \"合并\",\"action\":\"merge\",\"method\":\"onMerge\"},{\"label\": \"锁定\",\"action\":\"changeLock\",\"method\":\"onChangeLock\"},{\"label\": \"作废\",\"action\":\"delete\",\"method\":\"onDelete\"}] }' WHERE `name`='处方列表';
insert into sys_function(name,code,module_id,seq) values('门诊审方','MZ_AUTH_RECIPE',19,13),('住院审方','ZY_AUTH_RECIPE',19,14);
update sys_config set value='Y' where name='IS_CHECK_EXPRESSCODE';

update sys_function set use_state=1 where code in('TRANS_RECIPE_IMPORT','TRANS_RECIPE_PRINT','TRANS_ORAL_PASTE_PRINT','TRANS_COMPONENT_PRINT');
update sys_function set use_state=1 where code in('RECIPE_CHECKED','RECIPE_UNCHECKED');
update sys_config set value='Y' WHERE name='MUST_SUBSIDE';

/**
 * 以上在院内正式与uat都已执行-- by fenglei  2018/2/1
 */
 
INSERT INTO `sys_config` (`name`,`value`,`type`,`comments`)VALUES('ERROR_TIME','0',0,'煎煮时间差');
delete FROM wxzyy.sys_shipping_state where state_name in ('已配药接方','已开始配送');
/**
 * 以上在院内正式与uat都已执行-- by fenglei  2018/2/2
 */
